...
export default function BudgetForm({ onSubmit, initialData }) {
    ...
    return (
        <div className="bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center rounded-3xl p-4">

            <form
                onSubmit={handleSubmit}
                className="relative rounded-3xl shadow-2xl p-8 backdrop-blur-xl bg-white/10 border border-white/20 space-y-10 w-full max-w-xl mx-auto"
            ...
            >
                ...
                <div className="pt-4">
                    <button
                        ...
                        className="relative w-full py-4 bg-gradient-to-r from-purple-600 via-pink-600 to-cyan-600 text-white font-bold rounded-2xl shadow-lg overflow-hidden"
                    >
                        <div className="absolute inset-0 bg-gradient-to-r from-purple-700 via-pink-700 to-cyan-700 opacity-0 transition-opacity duration-300"></div>
